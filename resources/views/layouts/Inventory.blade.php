            ...
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <!-- <li><a class="has-arrow active " href="javascript:void()" aria-expanded="false">
                     ...
                     <li><a href="/administrator/inventory-dashboard" class="ai-icon" aria-expanded="false">
                 ...
                 <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                             <!-- <li><a href="/administrator/add-category">Add New</a></li> -->
                            <li><a href="/administrator/inventory/active-categories">Active</a></li>
                            <li><a href="/administrator/inventory/blocked-categories">Blocked</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/inventory/add-product">Add New</a></li>
                            <li><a href="/administrator/inventory/stockin-products">In Stock</a></li>
                            <li><a href="/administrator/inventory/stockout-products">Out Of Stock</a></li>
                            <li><a href="/administrator/inventory/blocked-products">Blocked</a></li>
                        </ul>
                    </li>
                     ...
                     <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/administrator/inventory/add-purchase">Add New</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                             <li><a href="/administrator/inventory/add-supplier">Add New</a></li>
                            <li><a href="/administrator/inventory/active-suppliers">Active</a></li>
                            <li><a href="/administrator/inventory/blocked-suppliers">Blocked</a></li>
                        </ul>
                    </li>

                     <li><a href="/administrator/inventory/reports" class="ai-icon" aria-expanded="false">
